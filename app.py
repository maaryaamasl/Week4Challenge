...
st.header("Task 3: Interactive Outlier Detection and Handling")
...
st.header("Hypothesis 1: Regression Plot VALUE vs ACTUAL")
...
st.header("Hypothesis 3: Forecast Error Over Time")
